/**
 * ***************************************************************************
 * Copyright (c) 2018 RiceFish Limited Project: SmartMES Version: 1.6
 *
 * This file is part of SmartMES.
 *
 * SmartMES is Authorized software; you can redistribute it and/or modify it under the terms of the GNU Affero General Public License as published by the Free Software
...
public class LocationValidators {
    ...
    public boolean hasAlgorithm(final DataDefinition dataDefinition, final Entity entity) {
        if (LocationType.WAREHOUSE.equals(LocationType.parseString(entity.getStringField(LocationFields.TYPE)))
            ...
            entity.addError(dataDefinition.getField(LocationFieldsMFR.ALGORITHM), "smartView.validate.field.error.missing");
            return false;
        }
