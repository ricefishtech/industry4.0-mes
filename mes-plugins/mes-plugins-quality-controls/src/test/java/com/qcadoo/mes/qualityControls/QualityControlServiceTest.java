...
public class QualityControlServiceTest {
    ...
    public void shouldSetErrorOnCommentFieldForResultType() {
        ...
        // then
        verify(entity).addGlobalError("smartView.validate.global.error.custom");
    ...
    public void shouldAddFailureMessageOnNoValueForFormComponent() {
        ...
        // then
        verify(state).addMessage("smartView.form.entityWithoutIdentifier", MessageType.FAILURE);
    }
    ...
    public void shouldAddFailureMessageOnNoValueForNonFormComponent() {
        ...
        // then
        verify(state).addMessage("smartView.grid.noRowSelectedError", MessageType.FAILURE);
    }
    ...
    public void shouldSetErrorMessageOnEmptyOperationField() {
        ...
        // then
        verify(qualityControl).addGlobalError("smartView.validate.global.error.custom");
