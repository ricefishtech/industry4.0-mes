...
public class ParametersListenersOTest {
    ...
    public void shouldRedirectToDeviationsDictionaryIfDictionaryIdIsntNull() {
        ...
        given(dataDefinitionService.get("smartModel", "dictionary")).willReturn(dictionaryDD);
        ...
        String url = "../page/smartDictionaries/dictionaryDetails.html?context={\"form.id\":\"" + dictionaryId + "\"}";
