...
public class PlannedEventsXlsService {
    ...
    private String getValue(Object value) {
        if (value == null) {
            return translationService.translate("smartView.false", LocaleContextHolder.getLocale());
        }
        if ((Boolean) value) {
            return translationService.translate("smartView.true", LocaleContextHolder.getLocale());
        } else {
            return translationService.translate("smartView.false", LocaleContextHolder.getLocale());
        }
