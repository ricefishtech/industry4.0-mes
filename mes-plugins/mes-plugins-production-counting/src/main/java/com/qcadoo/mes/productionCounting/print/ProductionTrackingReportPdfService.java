...
public class ProductionTrackingReportPdfService extends PdfDocumentService {
    ...
    private static final String L_QCADOO_VIEW_FALSE = "smartView.false";

    private static final String L_QCADOO_VIEW_TRUE = "smartView.true";
    ...
    protected void buildPdfContent(final Document document, final Entity productionTrackingReport, final Locale locale)
        ...
        final String documentAuthor = translationService.translate("smartReport.commons.generatedBy.label", locale);
