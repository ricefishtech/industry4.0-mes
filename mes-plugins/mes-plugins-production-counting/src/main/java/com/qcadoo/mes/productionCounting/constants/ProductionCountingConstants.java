...
public final class ProductionCountingConstants {
    ...
    // ricefishM
    public static final String MODEL_TRACKING_OPERATION_PRODUCT_IN_COMPONENT_EXT = "trackingOperationProductInComponentExt";
    //ricefishM
    public static final String MODEL_TRACKING_OPERATION_PRODUCT_OUT_COMPONENT_EXT = "trackingOperationProductOutComponentExt";
