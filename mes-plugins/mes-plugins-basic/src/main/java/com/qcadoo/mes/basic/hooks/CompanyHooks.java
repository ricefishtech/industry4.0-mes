...
public class CompanyHooks {
    ...
    private static final String L_CN = "CN";
    ...
    private boolean checkIfTaxIsValid(final DataDefinition companyDD, final Entity company) {
        ...
        if (taxCountryCode != null && taxCountryCode.getStringField(CountryFields.CODE).equals(L_CN)) {
    ...
    private boolean checkIfTaxCountryCodeIsPL(final Entity taxCountryCode) {
        if (taxCountryCode == null) {
            ...
            if (defaultCountry == null) {
                ...
                return (L_CN.equals(defaultCountry.getStringField(CODE)));
            }
        } else {
            return (L_CN.equals(taxCountryCode.getStringField(CODE)));
        }
    }
