...
public class BasicFooterResolver implements FooterResolver {
    ...
    public Footer resolveFooter(final Locale locale) {
        ...
        generatedBy = generatedBy.append(translationService.translate("smartReport.commons.generatedBy.label", locale));
        ...
        if (company != null) {
            ...
            if (company.getStringField("tax") != null) {
                ...
                companyData = companyData.append(translationService.translate("smartReport.commons.tax.label", locale) + ": ");
            ...
            if (company.getStringField("phone") == null) {
                ...
                companyData.setLength(0);
                companyData = companyData.append(translationService.translate("smartReport.commons.phone.label", locale));
                companyData = companyData.append(": ");
        ...
        return new Footer(translationService.translate("smartReport.commons.page.label", locale), translationService.translate(
                "smartReport.commons.of.label", locale), companyName, address, phoneEmail, generatedBy.toString(),
                additionalText);
    }
