...
//RicefishDev
    public void fillForOneDivision(final Entity technology, final ViewDefinitionState view) {
    ...
    //RicefishDev
    public void fillForManyDivision(final Entity technology, final ViewDefinitionState view) {
