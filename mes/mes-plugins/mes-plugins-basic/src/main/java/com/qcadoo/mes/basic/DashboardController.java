...
public final class DashboardController {
    ...
    public ModelAndView getDashboardView(@RequestParam final Map<String, String> arguments, final Locale locale) {
        ...
        mav.addObject("totalOrder", ordersService.totalOrder());
        mav.addObject("producedOrder", ordersService.producedOrder());
        mav.addObject("shippedOrder", ordersService.shippedOrder());
        mav.addObject("productionOrder", ordersService.productionOrder());

        //RicefishDev 加载首页
        //mav.setViewName("basic/dashboard");
        mav.setViewName("productionCounting/dashboard");
