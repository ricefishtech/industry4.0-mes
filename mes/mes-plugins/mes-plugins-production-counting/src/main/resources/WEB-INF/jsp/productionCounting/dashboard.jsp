    ...
    <body>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-simple text-center card-box">
                            <h3 class="text-success counter font-bold mt-0">${totalOrder}</h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-simple text-center card-box">
                            <h3 class="text-primary counter font-bold mt-0">${producedOrder}</h3>
                            <p class="text-muted mb-0">已生产订单</p>
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-6">
                        <div class="widget-simple text-center card-box">
                            <h3 class="text-pink font-bold mt-0"><span class="counter">${shippedOrder}</span></h3>
                            <p class="text-muted mb-0">已发货订单</p>
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-6">
                        <div class="widget-simple text-center card-box">
                            <h3 class="text-dark counter font-bold mt-0">${productionOrder}</h3>
                            <p class="text-muted mb-0">生产中订单</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">我的任务--生产订单的操作编码</h4>
        ...
        <script type="text/javascript">
            ...
            var dttable = $('#datatable').DataTable( {
                refresh: "/integration/rest/getBarcodeList.html",
                language: {
               ...
               // "bAutoWidth" : false,//是否自动适应宽度
                ...
                "renderer": "bootstrap",
                "ajax": {
                    "url":  "/integration/rest/getBarcodeList.html",
                    "method": "GET",
                },
               ...
               // "deferLoading": 30,
                columns: [
                    ...
                    {
                        "data": function(obj){
                            return getMyDate(obj.startdate)//通过调用函数来格式化所获取的时间戳
                        },
                        "sWidth" : "10%"//列的宽度
                    },
                    {
